...
func TestIterationService_CreateIteration_Success(t *testing.T) {
	...
	mockIterationRepo.GetIterationFunc = func(ctx context.Context, number int) (*entities.IterationEntity, error) {
		return nil, tmerrors.ErrNotFound // Iteration doesn't exist yet
	}
...
func TestIterationService_CreateIteration_DuplicateNumber(t *testing.T) {
	...
	mockIterationRepo.SaveIterationFunc = func(ctx context.Context, iteration *entities.IterationEntity) error {
		...
		return tmerrors.ErrAlreadyExists // Should not be reached
	}
...
func TestIterationService_DeleteIteration_Success(t *testing.T) {
	...
	mockIterationRepo.GetIterationFunc = func(ctx context.Context, number int) (*entities.IterationEntity, error) {
		...
		return nil, tmerrors.ErrNotFound // After delete, not found
	}
...
func TestIterationService_StartIteration_Success(t *testing.T) {
	...
	mockIterationRepo.GetCurrentIterationFunc = func(ctx context.Context) (*entities.IterationEntity, error) {
		return nil, tmerrors.ErrNotFound // No current iteration
	}
...
func TestIterationService_AddTask_TaskNotFound(t *testing.T) {
	...
	if err != tmerrors.ErrNotFound {
		// Check if it's wrapped
		var found bool
		for e := err; e != nil; {
			if e == tmerrors.ErrNotFound {
				found = true
				break
			}
			// Try to unwrap
...
func TestIterationService_CreateIteration_NumberGenerationSequential(t *testing.T) {
	...
	mockIterationRepo.GetIterationFunc = func(ctx context.Context, number int) (*entities.IterationEntity, error) {
		return nil, tmerrors.ErrNotFound // Not exists
	}
...
// TestIterationService_RevertIteration_Success tests reverting a completed iteration
func TestIterationService_RevertIteration_Success(t *testing.T) {
	service, ctx, mockIterationRepo, _, _, _ := setupIterationTestService(t)

	// Create a completed iteration
	iteration := createTestIterationEntity(t, 1, string(entities.IterationStatusComplete))
	...
	var updatedIteration *entities.IterationEntity
	mockIterationRepo.UpdateIterationFunc = func(ctx context.Context, iter *entities.IterationEntity) error {
		updatedIteration = iter
		return nil
	}

	err := service.RevertIteration(ctx, 1)
	if err != nil {
		t.Fatalf("RevertIteration() failed: %v", err)
	}

	if updatedIteration == nil {
		t.Fatal("UpdateIteration was not called")
	}

	if updatedIteration.Status != string(entities.IterationStatusPlanned) {
		t.Errorf("Status = %s, want %s", updatedIteration.Status, string(entities.IterationStatusPlanned))
	}
}

// TestIterationService_RevertIteration_NotFound tests reverting a non-existent iteration
func TestIterationService_RevertIteration_NotFound(t *testing.T) {
	service, ctx, mockIterationRepo, _, _, _ := setupIterationTestService(t)
	...
	err := service.RevertIteration(ctx, 999)
	if err == nil {
		t.Error("Expected error for non-existent iteration")
	}
}

// TestIterationService_RevertIteration_NotCompleted tests reverting an iteration that is not completed
func TestIterationService_RevertIteration_NotCompleted(t *testing.T) {
	service, ctx, mockIterationRepo, _, _, _ := setupIterationTestService(t)

	// Create an iteration in planned status
	iteration := createTestIterationEntity(t, 1, string(entities.IterationStatusPlanned))
	...
	err := service.RevertIteration(ctx, 1)
	if err == nil {
		t.Error("Expected error when reverting non-completed iteration")
	}
}

// TestIterationService_RevertIteration_InvalidNumber tests reverting with invalid iteration number
func TestIterationService_RevertIteration_InvalidNumber(t *testing.T) {
	service, ctx, _, _, _, _ := setupIterationTestService(t)
