...
const (
	...
	// Deprecated: use EventTaskDeleted with proper prefix
	EventTaskDeletedLegacy = "task.deleted"
)

// Iteration Events (4 events)
const (
...
// Acceptance Criteria Events (7 events)
const (
